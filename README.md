...
![CI](https://github.com/CodebyJosey/sra-checker/actions/workflows/ci.yml/badge.svg)
...
- Case door Mees Konijnendijk & Yeslin Beljaars (cc: Thom van der Velden) van Bonsai SoftwareJ.
- SRA-checklist © SRA.
